...
/**
	 ...
	 * 设置：预离时间
	 */
	public void setYulifangshijian(Date yulifangshijian) {
		this.yulifangshijian = yulifangshijian;
	}
	/**
	 * 获取：预离时间
	 */
	public Date getYulifangshijian() {
		return yulifangshijian;
	}
