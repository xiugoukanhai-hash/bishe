  ...
  methods: {
    ...
    getHuiyuanList() {
      this.$http({
        ...
        if (data && data.code === 0) {
          this.huiyuanList = data.data.list;
    ...
    zhanghaoChange(val) {
      let huiyuan = this.huiyuanList.find(item => item.zhanghao === val);
      if (huiyuan) {
        this.ruleForm.xingming = huiyuan.xingming;
        this.ruleForm.shenfenzheng = huiyuan.shenfenzheng;
        this.ruleForm.shouji = huiyuan.shouji;
      }
    },
    onSubmit() {
