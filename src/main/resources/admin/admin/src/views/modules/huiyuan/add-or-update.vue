<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="账户余额" prop="zhanguhuyue">
          <el-input v-model="ruleForm.zhanguhuyue"
              placeholder="账户余额" clearable  :readonly="ro.zhanguhuyue"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="账户余额" prop="zhanguhuyue">
              <el-input v-model="ruleForm.zhanguhuyue"
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          ...
          if(o=='zhanguhuyue'){
            this.ruleForm.zhanguhuyue = obj[o];
            this.ro.zhanguhuyue = true;
            continue;
          }
        }
      }
